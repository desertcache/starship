...
const GUNMETAL_PLATES = layoutPlates(layoutRand, 5);
...
function buildHullDiffuse(): THREE.CanvasTexture {
  return cached('hull-skin-diffuse', () => {
    ...
    drawSeams(ctx, TEX_SIZE, TEX_SIZE, PANEL_PX, PANEL_PX, 'rgba(20,16,10,0.6)', 3);
    ...
    // Occasional gunmetal repair plates.
    ...
    addGrime(ctx, TEX_SIZE, TEX_SIZE, 931, 0.22);
